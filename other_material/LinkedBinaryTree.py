...
if __name__ == '__main__':
    ...
    mytree._add_root( "Are you nervous?" )
    mytree.preorder_print( mytree.root() )

    mytree._add_left( mytree.root(), "Saving account." )
    theright = mytree._add_right( mytree.root(), "Will you need to access most of the money within the next 5 years?" )
    mytree._add_left( theright, "Money market fund." )
    theright = mytree._add_right( theright, "Are you willing to accept risks in exchange for higher expected returns?" )
    mytree._add_left( theright, "Stock portfolio." )
    theright = mytree._add_right( theright, "Diversified portfolio with stocks, bonds, and short-term instruments." )
